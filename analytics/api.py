...
def get_summary_stats(request):
    try:
        ...
        cat_hours = {
            ...
            'getting_ready': [0.0] * num_slots,
            'phone_call': [0.0] * num_slots,
            'break': [0.0] * num_slots,
        ...
        return JsonResponse({
            ...
            'time_audit_breakdown': {
                ...
                'getting_ready_hours': [round(x, 2) for x in cat_hours['getting_ready']],
                'phone_call_hours': [round(x, 2) for x in cat_hours['phone_call']],
                ...
                'getting_ready_minutes': cat_mins['getting_ready'],
                'phone_call_minutes': cat_mins['phone_call'],
